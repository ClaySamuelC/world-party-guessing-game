  ...
  return (
    <div className="home">
      <div className="home-card">
        ...
        <p className="tagline">Party pack of mini-games on a shared world map, plus Elimination as its own mode. Up to {MAX_PLAYERS} friends, peer-to-peer, no server.</p>
