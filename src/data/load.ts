...
import type { Country, CountryFeatureProps, Place, SourcesManifest } from './types'
...
export function loadDataset(): Promise<Dataset> {
  cached ??= (async () => {
    const [countries, places, geojson, sources] = await Promise.all([
    ...
    return { countries, countryList, places, geojson, sources }
  })()
  return cached
}
